...
def frame_extractor_registration(instance, dir_name) -> bool:
    """
    ...
    current_frame = 0
    media_dir_temp = os.path.dirname(ATTENDANCE_MEDIA_ROOT)
    media_dir = os.path.join(media_dir_temp, 'jpg_registration')
...
def frame_extractor_attendence(instance, dir_name) -> bool:
    """
    ...
    current_frame = 0
    media_dir_temp = os.path.dirname(ATTENDANCE_MEDIA_ROOT)
    media_dir = os.path.join(media_dir_temp, 'jpg_attendance')
    # a = os.path.join(media_dir, )
    # print(os.path.dirname(ATTENDANCE_MEDIA_ROOT))
